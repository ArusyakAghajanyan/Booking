...
<span><button class='base-button base-button--secondary cards-delete-button' data-id='${item.id}'>Delete</button></span>
<span><button class='base-button base-button--secondary cards-edit-button' data-id='${item.id}'>Edit</button></span>
</div>`    
}
`    
},
