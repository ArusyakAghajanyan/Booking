...
// https://internship-project-48d44-default-rtdb.firebaseio.com

fetch('https://inhttps://internship-project-70fc1-default-rtdb.firebaseio.com/ternship-project-48d44-default-rtdb.firebaseio.com/col.json') //ֆայրբեյսն ասում ա, որ լինքը գրելուց հետո անպայման վերջում գրենք .json//
    .then((res) => res.json())
    .then((data) => {
        console.log(data);
    });
